# -*- coding: utf-8 -*-
"""HW6_diffusion_model.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17HLsW3I210Lj7lR-8RUkXm8g3uBfSi-4
...
class GaussianDiffusion(nn.Module):
    ...
    def p_sample_loop(self, shape, return_all_timesteps = False):
        ...
        for i in range(0, self.num_timesteps, self.num_timesteps//20):
            image = np.transpose(imgs[i].cpu().numpy(), (0, 2, 3, 1))
            for j in range(5):
                if j == 0:
                    tmp = image[j]
                else:
                    tmp = np.concatenate((tmp, image[j]), axis=0)
            if i == 0:
                output = tmp
            else:
        ...
        plt.imshow(output)
        plt.axis('off')
        plt.savefig('interpolation.png', bbox_inches='tight', pad_inches=0)
        plt.close()
