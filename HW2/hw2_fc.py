...
for epoch in range(num_epoch):
    ...
    train_acc_l.append(train_acc/len(train_set)*100)
    val_acc_l.append(val_acc/len(val_set)*100)
...
ax1.plot(range(1, len(train_acc_l)+1), train_acc_l, label='Train acc')
ax1.set_xlabel('Num of epoch')
ax1.set_ylabel('Accuracy(%)')
ax1.set_title('Train Accuracy')
ax1.legend()
ax1.set_ylim([0, 100])

ax2.plot(range(1, len(val_acc_l)+1), val_acc_l, label='Val acc')
ax2.set_xlabel('Num of epoch')
...
if not os.path.exists(os.path.dirname('./output/prediction_fc.csv')):
    os.makedirs(os.path.dirname('./output/prediction_fc.csv'))
